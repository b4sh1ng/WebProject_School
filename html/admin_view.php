        ...
        <div class="leftDiv">
            ...
            <form action="admin_view.php" method="post">
                ...
                <div class="button-container">
                    ...
                    <input type="submit" value="2FA Aktivieren" name="btn_2fa" class="btn btn-warning" style="margin-left: 1em; margin-bottom: 1em;" />
                    <input type="submit" value="2FA Deaktivieren" name="btn_no_2fa" class="btn btn-warning" style="margin-left: 1em; margin-bottom: 1em;" />
                    <input type="submit" value="Ausloggen" name="btn_logout" class="btn btn-warning" style="margin-left: 1em; margin-bottom: 1em;" />
        ...
        <div class="rightDiv">
            <div style="margin: 5px;">
                ...
                if (isset($_POST['btn_2fa'])) {
                    ...
                    echo "<script> location.replace(\"2fa_key.php\"); </script>";
                }
                ?>
            </div>
        </div>
